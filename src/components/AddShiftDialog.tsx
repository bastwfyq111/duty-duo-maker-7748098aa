...
const PRESET_COLORS = [
  ...
  "142 71% 45%",  // أخضر
  "120 60% 40%",  // أخضر غامق
  "84 81% 44%",   // أخضر ليموني
  "60 90% 50%",   // أصفر
  "45 93% 47%",   // ذهبي
  "38 92% 50%",   // برتقالي
  "25 95% 53%",   // برتقالي محروق
  "14 90% 53%",   // أحمر-برتقالي
  "0 84% 60%",    // أحمر
  "350 80% 55%",  // وردي غامق
  "330 81% 60%",  // وردي
  "300 76% 55%",  // فوشيا
  "280 70% 55%",  // بنفسجي
  "263 70% 50%",  // بنفسجي غامق
  "240 60% 55%",  // نيلي
  "210 20% 50%",  // رمادي
  "215 25% 35%",  // رمادي غامق
  "30 40% 45%",   // بني
  "20 30% 35%",   // بني غامق
  // ألوان جديدة (محسّنة للتمييز البصري)
  "158 64% 52%",  // زمردي فاتح
  "174 72% 56%",  // تركوازي فاتح
  "12 88% 59%",   // مرجاني محمر
  "252 83% 74%",  // خزامى فاتح
  "48 96% 53%",   // كهرماني ذهبي
  "204 80% 45%",  // أزرق محيطي
  "322 75% 68%",  // وردي ماجنتا
  "225 45% 62%",  // أزرق دخاني
  "88 55% 48%",   // أخضر زيتوني فاتح
  "185 65% 45%",  // أزرق سماوي عميق
  "291 64% 68%",  // بنفسجي أوركيد
  "355 78% 68%",  // وردي مرجاني
];
